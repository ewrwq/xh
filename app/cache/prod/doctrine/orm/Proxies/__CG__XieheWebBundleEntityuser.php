 ...
 */
class user extends \Xiehe\WebBundle\Entity\user implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'nickname', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\user' . "\0" . 'questions', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\user' . "\0" . 'answers', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\user' . "\0" . 'hospital', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
