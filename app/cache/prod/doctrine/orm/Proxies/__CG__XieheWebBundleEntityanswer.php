 ...
 */
class answer extends \Xiehe\WebBundle\Entity\answer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'id', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'text', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'createTime', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'originalEditionId', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'question', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'creater', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\answer' . "\0" . 'comments');
        }
