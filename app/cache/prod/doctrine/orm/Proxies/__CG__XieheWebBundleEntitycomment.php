 ...
 */
class comment extends \Xiehe\WebBundle\Entity\comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\comment' . "\0" . 'id', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\comment' . "\0" . 'text', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\comment' . "\0" . 'createTime', '' . "\0" . 'Xiehe\\WebBundle\\Entity\\comment' . "\0" . 'answer');
        }
